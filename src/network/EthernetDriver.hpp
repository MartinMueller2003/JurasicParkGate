...
public:
    ...
    void SetParent (c_EthernetDriver* parent)
    {
        pEthernetDriver = parent;
    }
    void GetDriverName (String & value)
    {
        value = CN_EthDrv;
    }
    }; // fsm_Eth_state
...
public:
    ...
    void Poll                ();
    bool IsConnected         ();
    inline void SetFsmState         (fsm_Eth_state* NewState)
    {
        pCurrentFsmState = NewState;
    }
    void AnnounceState       ();
    FastTimer &GetFsmTimer         ()
    {
        return(FsmTimer);
    }
    ...
    void StartEth            ();
    void InitPowerPin        ();
    inline uint32_t GetPowerPinActiveDelayMs ()
    {
...
private:
    ...
    void onEventHandler         (const WiFiEvent_t  event,
